...
function parseRichText(html) {
    return html.split(/(<br\s*\/?>|<em>.*?<\/em>)/g).map((part, i) => {
        ...
        if (em)
            return React.createElement("em", { key: i }, em[1]);
        return part;
    });
}
const LANG_OPTIONS = [
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement("nav", { className: "navbar" },
            React.createElement("div", { className: "container" },
                React.createElement("a", { href: "#", className: "navbar-logo" },
                    React.createElement(VasiLogo, null),
                    React.createElement("span", { className: "navbar-wordmark" }, "Vasi")),
                React.createElement("ul", { className: "navbar-links" },
                    React.createElement("li", null,
                        React.createElement("a", { href: "#features" }, t.nav_features)),
                    React.createElement("li", null,
                        React.createElement("a", { href: "#how" }, t.nav_how)),
                    React.createElement("li", null,
                        React.createElement("a", { href: "#pricing" }, t.nav_pricing)),
                    React.createElement("li", null,
                        React.createElement("a", { href: "#about" }, t.nav_about))),
                React.createElement("div", { className: "navbar-actions" },
                    React.createElement("div", { className: "lang-switcher", ref: langRef },
                        React.createElement("button", { className: "lang-btn", onClick: (e) => { e.stopPropagation(); setMenuOpen(v => !v); } },
                            React.createElement("span", null, "\uD83C\uDF10"),
                            React.createElement("span", null, t.label)),
                        menuOpen && (React.createElement("div", { className: "lang-menu" }, LANG_OPTIONS.map(opt => (React.createElement("div", { key: opt.code, className: `lang-opt${lang === opt.code ? ' lang-active' : ''}`, onClick: () => handleLang(opt.code) },
                            React.createElement("span", null, opt.flag),
                            React.createElement("span", null, opt.name))))))),
                    React.createElement("a", { href: "/login", className: "btn btn-ghost btn-md" }, t.nav_login),
                    React.createElement("a", { href: "/register", className: "btn btn-primary btn-md" }, t.nav_cta)))),
        React.createElement("section", { className: "hero" },
            React.createElement("div", { className: "container" },
                React.createElement("div", { className: "hero-eyebrow" },
                    React.createElement("span", { className: "eyebrow-dot" }),
                    React.createElement("span", null, t.hero_eyebrow)),
                React.createElement("div", { className: "hero-logo-wrap" },
                    React.createElement(VasiLogo, null)),
                React.createElement("h1", { className: "hero-title" }, parseRichText(t.hero_title)),
                React.createElement("p", { className: "hero-sub" }, t.hero_sub),
                React.createElement("div", { className: "hero-actions" },
                    React.createElement("a", { href: "/register", className: "btn btn-primary btn-lg" }, t.hero_cta1),
                    React.createElement("a", { href: "#how", className: "btn btn-secondary btn-lg" }, t.hero_cta2)),
                React.createElement("div", { className: "hero-proof" },
                    React.createElement("div", { className: "proof-avatars" }, ['AK', 'ME', 'SY', 'BT'].map(initials => (React.createElement("div", { key: initials, className: "proof-avatar" }, initials)))),
                    React.createElement("span", null, t.hero_proof)),
                React.createElement("div", { className: "hero-mockup" },
                    React.createElement("div", { className: "mockup-glow" }),
                    React.createElement("div", { className: "mockup-card" },
                        React.createElement("div", { className: "mockup-bar" },
                            React.createElement("span", { className: "m-dot m-dot-r" }),
                            React.createElement("span", { className: "m-dot m-dot-y" }),
                            React.createElement("span", { className: "m-dot m-dot-g" }),
                            React.createElement("div", { className: "m-url" }, "\uD83D\uDD12 app.vasi.co/messages")),
                        React.createElement("div", { className: "msg-list" },
                            React.createElement("div", { className: "msg-row" },
                                React.createElement("div", { className: "msg-icon" }, "\uD83D\uDCDD"),
                                React.createElement("div", { className: "msg-body" },
                                    React.createElement("div", { className: "msg-title" }, t.mock_m1_title),
                                    React.createElement("div", { className: "msg-meta" }, t.mock_m1_meta)),
                                React.createElement("span", { className: "badge b-sched" }, t.badge_sched)),
                            React.createElement("div", { className: "msg-row" },
                                React.createElement("div", { className: "msg-icon" }, "\uD83D\uDD70\uFE0F"),
                                React.createElement("div", { className: "msg-body" },
                                    React.createElement("div", { className: "msg-title" }, t.mock_m2_title),
                                    React.createElement("div", { className: "msg-meta" }, t.mock_m2_meta)),
                                React.createElement("span", { className: "badge b-locked" }, t.badge_locked)),
                            React.createElement("div", { className: "msg-row" },
                                React.createElement("div", { className: "msg-icon" }, "\uD83D\uDC8C"),
                                React.createElement("div", { className: "msg-body" },
                                    React.createElement("div", { className: "msg-title" }, t.mock_m3_title),
                                    React.createElement("div", { className: "msg-meta" }, t.mock_m3_meta)),
                                React.createElement("span", { className: "badge b-sched" }, t.badge_sched)),
                            React.createElement("div", { className: "msg-row" },
                                React.createElement("div", { className: "msg-icon" }, "\uD83C\uDF93"),
                                React.createElement("div", { className: "msg-body" },
                                    React.createElement("div", { className: "msg-title" }, t.mock_m4_title),
                                    React.createElement("div", { className: "msg-meta" }, t.mock_m4_meta)),
                                React.createElement("span", { className: "badge b-delivered" }, t.badge_delivered))))))),
        ...
        ].map(s => (React.createElement("div", { key: s.lbl, className: "stat" },
            React.createElement("div", { className: "stat-val" }, s.val),
            React.createElement("div", { className: "stat-lbl" }, s.lbl))))),
        React.createElement("div", { className: "rule" }),
        React.createElement("section", { className: "section", id: "features" },
            React.createElement("div", { className: "container" },
                React.createElement("div", { className: "sec-hdr center" },
                    React.createElement("div", { className: "sec-tag" }, t.feat_tag),
                    React.createElement("h2", { className: "sec-title" }, parseRichText(t.feat_title)),
                    React.createElement("p", { className: "sec-sub" }, t.feat_sub)),
                ...
                ].map(f => (React.createElement("div", { key: f.title, className: "feat-card" },
                    React.createElement("div", { className: "feat-icon" }, f.icon),
                    React.createElement("div", { className: "feat-title" }, f.title),
                    React.createElement("div", { className: "feat-desc" }, f.desc))))))),
        React.createElement("section", { className: "section how-section", id: "how" },
            React.createElement("div", { className: "container" },
                React.createElement("div", { className: "sec-hdr center" },
                    React.createElement("div", { className: "sec-tag" }, t.how_tag),
                    React.createElement("h2", { className: "sec-title" }, parseRichText(t.how_title))),
                ...
                ].map(s => (React.createElement("div", { key: s.title, className: "how-step" },
                    React.createElement("div", { className: `how-num${s.active ? ' active' : ''}` }, s.icon),
                    React.createElement("div", { className: "how-title" }, s.title),
                    React.createElement("div", { className: "how-desc" }, s.desc))))))),
        React.createElement("section", { className: "section", id: "pricing" },
            React.createElement("div", { className: "container" },
                React.createElement("div", { className: "sec-hdr center" },
                    React.createElement("div", { className: "sec-tag" }, t.pricing_tag),
                    React.createElement("h2", { className: "sec-title" }, t.pricing_title),
                    React.createElement("p", { className: "sec-sub" }, t.pricing_sub)),
                React.createElement("div", { className: "pricing-grid pricing-grid--two" },
                    React.createElement("div", { className: "plan-card" },
                        React.createElement("div", { className: "plan-name" }, t.plan_free_name),
                        React.createElement("div", { className: "plan-price" },
                            React.createElement("span", { className: "plan-amount" }, "\u20BA0"),
                            React.createElement("span", { className: "plan-per" }, t.plan_per)),
                        React.createElement("div", { className: "plan-desc" }, t.plan_free_desc),
                        React.createElement("div", { className: "plan-line" }),
                        React.createElement("div", { className: "plan-feats" }, [t.plan_free_f1, t.plan_free_f2, t.plan_free_f3].map(f => (React.createElement("div", { key: f, className: "plan-feat" },
                            React.createElement("span", { className: "plan-check" }, "\u2713"),
                            React.createElement("span", null, f))))),
                        React.createElement("a", { href: "#", className: "btn btn-secondary btn-md plan-btn" }, t.plan_free_cta)),
                    React.createElement("div", { className: "plan-card featured" },
                        React.createElement("div", { className: "plan-popular" }, t.plan_popular),
                        React.createElement("div", { className: "plan-name" }, t.plan_personal_name),
                        React.createElement("div", { className: "plan-price" },
                            React.createElement("span", { className: "plan-amount" }, "\u20BA490"),
                            React.createElement("span", { className: "plan-per" }, t.plan_per)),
                        React.createElement("div", { className: "plan-desc" }, t.plan_personal_desc),
                        React.createElement("div", { className: "plan-line" }),
                        React.createElement("div", { className: "plan-feats" }, [t.plan_personal_f1, t.plan_personal_f2, t.plan_personal_f3, t.plan_personal_f4, t.plan_personal_f5].map(f => (React.createElement("div", { key: f, className: "plan-feat" },
                            React.createElement("span", { className: "plan-check" }, "\u2713"),
                            React.createElement("span", null, f))))),
                        React.createElement("a", { href: "#", className: "btn btn-primary btn-md plan-btn" }, t.plan_personal_cta))))),
        React.createElement("section", { className: "section" },
            React.createElement("div", { className: "container" },
                React.createElement("div", { className: "cta-wrap" },
                    React.createElement("h2", { className: "cta-title" }, t.cta_title),
                    React.createElement("p", { className: "cta-sub" }, t.cta_sub),
                    React.createElement("div", { className: "cta-actions" },
                        React.createElement("a", { href: "/register", className: "btn btn-primary btn-lg" }, t.cta_btn1),
                        React.createElement("a", { href: "#how", className: "btn btn-ghost btn-lg" }, t.cta_btn2))))),
        React.createElement("footer", { className: "footer", id: "about" },
            React.createElement("div", { className: "container" },
                React.createElement("div", { className: "footer-grid" },
                    React.createElement("div", null,
                        React.createElement("div", { className: "footer-logo" },
                            React.createElement(VasiLogo, null),
                            React.createElement("span", { className: "footer-logo-txt" }, "Vasi")),
                        React.createElement("p", { className: "footer-tagline" }, t.footer_tagline)),
                    React.createElement("div", null,
                        React.createElement("div", { className: "col-title" }, t.col_product),
                        React.createElement("div", { className: "col-links" },
                            React.createElement("a", { href: "#" }, t.fp1),
                            React.createElement("a", { href: "#" }, t.fp2),
                            React.createElement("a", { href: "#" }, t.fp3),
                            React.createElement("a", { href: "#" }, t.fp4))),
                    React.createElement("div", null,
                        React.createElement("div", { className: "col-title" }, t.col_company),
                        React.createElement("div", { className: "col-links" },
                            React.createElement("a", { href: "#" }, t.fc1),
                            React.createElement("a", { href: "#" }, t.fc2),
                            React.createElement("a", { href: "#" }, t.fc3),
                            React.createElement("a", { href: "#" }, t.fc4))),
                    React.createElement("div", null,
                        React.createElement("div", { className: "col-title" }, t.col_legal),
                        React.createElement("div", { className: "col-links" },
                            React.createElement("a", { href: "#" }, t.fl1),
                            React.createElement("a", { href: "#" }, t.fl2),
                            React.createElement("a", { href: "#" }, t.fl3),
                            React.createElement("a", { href: "#" }, t.fl4)))),
                React.createElement("div", { className: "footer-bottom" },
                    React.createElement("div", { className: "footer-copy" }, t.footer_copy),
                    React.createElement("div", { className: "footer-links" },
                        React.createElement("a", { href: "#" }, "Instagram"),
                        React.createElement("a", { href: "#" }, "LinkedIn"),
                        React.createElement("a", { href: "#" }, "Twitter / X")))))));
}
